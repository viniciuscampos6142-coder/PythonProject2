...
ASSETS = {
    ...
    "background": "fase-final3.0.png",  # imagem de fundo

    "player": "nave-d-gerra.png",  # imagem da nave

    "meteor": "meteoro-final.png",  # imagem do meteoro

    "sound_point": "point-final.mp3",  # som ao desviar com sucesso

    "sound_hit": "som-dano-final.mp3",  # som de colisão

    "music": "som-final.mp3"  # música de fundo. direitos: Music by Maksym Malko from Pixabay
