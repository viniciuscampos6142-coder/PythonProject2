...
ASSETS = {
    "background": "foto-selva-2.png",                         # imagem de fundo
    "player": "nave-d-guerra.png",                                    # imagem da nave
    "meteor": "rocha.png",                                 # imagem do meteoro
    "sound_point": "ponto-selva.mp3", # som ao desviar com sucesso
    "sound_hit": "dano-selva.mp3",                # som de colisão
    "music": "retro-retro.mp3"          # música de fundo. direitos: Music by Maksym Malko from Pixabay
}
...
### ALTERADO: Lista de meteoros agora usa dicionários ###
meteor_list = []
for _ in range(5):
